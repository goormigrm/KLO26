...
**잰 것**: 대칭 `asym 500` **52.2%**(215승 88무 197패 · 골 1.90 : 1.84 — 500판 1σ ≈ 2.5%p 안). `verify` 슬라이더 지문 7/7 연결 · 짝 비교 6개 ✅ · "폭 → 코너킥" 만 2/5(동률 11) — 바꾸기 전 코드를 worktree 에서 같은 시드로 돌리면 3/5 △, 판정 쌍이 5개뿐인 지표의 한 쌍 차이다.
